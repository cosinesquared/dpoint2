...
onEvent('recipes', e => {
    ...
    e.recipes.create.emptying(['minecraft:glass_bottle', Fluid.of('cofh_core:honey', 250)], 'minecraft:honey_bottle').id('kubejs:emptying/honey_bottle')
  
    e.recipes.thermal.centrifuge(Fluid.of('cofh_core:honey', 100), '#forge:simple_honeycombs').id(`kubejs:thermal/centrifuge/centrifuge_honeycomb`)
    e.recipes.thermal.centrifuge(Fluid.of('cofh_core:honey', 900), '#forge:simple_honeycomb_blocks').id(`kubejs:thermal/centrifuge/centrifuge_honeycomb_block`)
    e.recipes.thermal.crucible(Fluid.of('cofh_core:honey', 1000), 'minecraft:honey_block').id('kubejs:thermal/crucible/crucible_honey_block_to_honey')
    ...
    cyclicHoneyMelter([
      ['minecraft:honey_bottle', 'cofh_core:honey', 250],
      ['minecraft:honey_block', 'cofh_core:honey', 1000],

...
onEvent('item.tags', e => {
    ...
    e.add('forge:pickaxes', ['engineerstools:redia_tool'])
    ...
    e.add('misctags:water/items', ['#forge:water', 'minecraft:water_bucket', 'create:honey_bucket', 'create:chocolate_bucket', 'mahoutsukai:murky_bucket'])
  ...
  onEvent('block.tags', e => {
    ...
    e.add('forge:ores/dimensionalshard', ['rftoolsbase:dimensionalshard_overworld', 'rftoolsbase:dimensionalshard_nether', 'rftoolsbase:dimensionalshard_end'])
    e.add('forge:ores', ['#forge:ores/certus_quartz', '#forge:ores/dimensionalshard', '#forge:ores/arcane_brick'])
    e.add('misctags:no_moving', ['#minecraft:wither_immune', 'appliedenergistics2:cable_bus', 'cookingforblockheads:fridge', /^refinedstorage:/,  /^appliedenergistics2:/,])
  ...
  onEvent('fluid.tags', e => {
    ...
    e.add('minecraft:water', ['cofh_core:honey', 'cyclic:honey'])
  })
  //#endregion
